        ...
        <div className="pb-10">
            <div className="px-4 pt-12 sm:px-6 lg:px-8 lg:pt-20">
                <div className="mb-4 text-center">
                    ...
                    <p className="mx-auto mt-3 max-w-4xl text-sm text-neutral-300 sm:mt-5 sm:text-xl">One year of free updates included, optional renewal at 40% discount.</p>
                </div>
            </div>
            <div className="mx-auto max-w-7xl px-4 pt-6 pb-16 sm:px-6 lg:px-8">
                <div className=" grid gap-4 sm:grid-cols-2 lg:grid-cols-[repeat(20,1fr)]">
                    <div className="flex lg:col-span-6 lg:py-10">
                        <div className="relative flex w-full flex-col rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
                            <div className="flex-1">
                                ...
                                <p className="mt-6 text-neutral-500">Simple and beautiful</p>
                                <ul role="list" className="mt-6 space-y-6">
                                    <li className="flex">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" aria-hidden="true" className="h-6 w-6 flex-shrink-0 text-purple-500">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7">
                                            </path>
                                        </svg>
                                        <span className="ml-3 text-neutral-500">1 macOS device</span>
                                    </li>
                                    <li className="flex">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" aria-hidden="true" className="h-6 w-6 flex-shrink-0 text-purple-500">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7">
                                        ...
                                        <span className="ml-3 text-neutral-500">No watermark</span>
                                    </li>
                                    <li className="flex">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" aria-hidden="true" className="h-6 w-6 flex-shrink-0 text-purple-500">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7">
                                        ...
                                        <span className="ml-3 text-neutral-500">1 year of updates</span>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div className="flex lg:col-span-6 lg:py-10">
                        <div className="relative flex w-full flex-col rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
                            <div className="flex-1">
                                <h3 className="text-xl font-semibold text-neutral-900">Personal</h3>
                                ...
                                <p className="mt-6 text-neutral-500">Most popular pick</p>
                                <ul role="list" className="mt-6 space-y-6">
                                    <li className="flex">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" aria-hidden="true" className="h-6 w-6 flex-shrink-0 text-purple-500">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7">
                                        ...
                                        <span className="ml-3 text-neutral-500">2 macOS devices</span>
                                    </li>
                                    <li className="flex">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" aria-hidden="true" className="h-6 w-6 flex-shrink-0 text-purple-500">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7">
                            ...
                            <div className="flex-1">
                                ...
                                <ul role="list" className="mt-6 space-y-6">
                                    <li className="flex">
                                        ...
                                        <span className="ml-3 text-neutral-500">3 macOS devices</span>
                                    </li>
                                    <li className="flex">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" aria-hidden="true" className="h-6 w-6 flex-shrink-0 text-purple-500">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7">
            ...
            <div className="my-10 text-center text-neutral-400">Prices in USD. Taxes may apply.<br />Secure payment via <a href="https://gumroad.com">gumroad</a>, macOS 10.15+ Required.</div>
            <div className="mx-auto max-w-xl px-4">
                <div className="my-10 rounded-md bg-neutral-800 p-4 text-center text-base">
            ...
            <div className="mx-auto my-24 max-w-xl px-4">
                ...
                <p className="my-4 text-center text-neutral-400">Manage your license key in the <a href="/license-manager" className="text-blue-500">License Manager</a>.</p>
            </div>
        </div>
    )
}
