...
const Appsumo = (props: any) => {
  ...
  const submitApi = async (e: { preventDefault: () => void }) => {
    ...
    if (code !== "null" && code.length === 19) {
      ...
      axios.post("api/verify", { email: email, phrase: code }).then((res) => {
        ...
        if (os === "macos") {
          window.open(
            "https://github.com/achuthhadnoor/annotate_www/releases/download/0.0.1/Annotate-0.0.1-arm64.dmg",
            "_blank"
          );
          setLoading(false);
          return;
  ...
  return (
    <Layout
      ...
      description="Download annotate for macOs and windows"
    >
      <section className=" mx-auto max-w-4xl">
        ...
        <div className="my-5 mx-auto mt-2">
          ...
          <p className="my-5 max-w-xl leading-loose">
            ...
            Annotate and get a visual mode for your app instantly
        ...
        <div className="my-5 mx-auto rounded-md bg-gray-900 px-4 py-5 shadow-md">
          <h3 className="mt-2 text-lg">
            Start annotating your amaizing digital work.
          </h3>
          <form
