  ...
  return (
    <>
      <div className="bg-gradient-to-b from-blue-500 to-black ">
        <div className="flex sticky top-0 z-50  items-center justify-between align-middle bg-black/30 p-2 backdrop-blur-md md:flex">
        ...
        <div className="container mx-auto py-16 px-4 sm:px-0 space-y-10">
          ...
          <div className="mt-12 flex flex-col items-center">
            ...
            <h1 className="max-w-xl text-4xl font-bold text-center mt-2">
          ...
          <div className="py-12 px-4">
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-x-8 md:gap-y-12 lg:grid-cols-3">
              ...
              <div>
                ...
                <dd className="mt-2 text-base text-blue-300">
                  After a successful purchase, license key will be displayed in
                  the checkout flow and it'll also be emailed to you afterwards.
                  Make sure to also check your Spam folder just in case.
                </dd>
              </div>
              <div>
                <dt className="text-lg leading-6 font-medium text-neutral-100">
                ...
                <dd className="mt-2 text-base text-blue-300">
                  There's currently no limit on how many devices you install and
                  use Annotate on. I rely on you being respectful, so please
                  don't share your license key with others and buy a separate
                  license per person.
                </dd>
              </div>
              <div>
              ...
              <div>
                ...
                <dd className="mt-2 text-base text-blue-300">
                  ...
                  <a href="mailto:vadim@getAnnotate.app" className="text-white">
                    vadim@getAnnotate.app
                  </a>{" "}
                  within 30 days of your purchase and I'll send you a refund, no
                  questions asked.
                </dd>
              </div>
            </dl>
