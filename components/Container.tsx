  ...
  return (
    <div className=" bg-gradient-to-b from-purple-900/20 text-neutral-300">
      ...
      <span className="fixed bottom-5 right-36 z-10">
        <a href="https://www.producthunt.com/products/annotate-6/reviews?utm_source=badge-product_review&utm_medium=badge&utm_souce=badge-annotate&#0045;6" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" width="250" height="54" viewBox="0 0 250 54" version="1.1">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              <g transform="translate(-130.000000, -73.000000)">
                <g transform="translate(130.000000, 73.000000)">
                  <rect stroke="#FF6154" stroke-width="1" fill="#FFFFFF" x="0.5" y="0.5" width="249" height="53" rx="10" />
                  <text fontFamily="Helvetica-Bold, Helvetica" fontSize="9" fontWeight="bold" fill="#FF6154">
                    <tspan x="53" y="20">LEAVE A REVIEW ON</tspan>
                  </text>
                  <text fontFamily="Helvetica-Bold, Helvetica" font-size="16" fontWeight="bold" fill="#FF6154">
                    <tspan x="52" y="40">Product Hunt</tspan>
                  </text>
                  <g transform="translate(205.000000, 11.000000) scale(1.4)" fill="#FF6154">
                    <g transform="translate(3, 00)"><path d="M23.04,9.021L14.77,8.796L12,1L9.23,8.796L0.96,9.021l6.559,5.043L5.177,22L12,17.321L18.823,22l-2.342-7.935L23.04,9.021z M12,14.896l-3.312,2.271l1.137-3.851l-3.183-2.448l4.014-0.109L12,6.974l1.344,3.784l4.014,0.109l-3.183,2.448l1.137,3.851 L12,14.896z" /></g>
                  </g>
